...
Вспомогательный локальный журнал содержит начало основного маршрута, отдельную
сессию pause/death/checkpoint/load и измерительные манёвры с повторениями. Для всех
