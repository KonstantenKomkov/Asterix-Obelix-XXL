...
- [ ] П. 7 — M0–M1: карта файлов и контрольные состояния
...
**Последнее обновление:** 21 июля 2026 — п. 6 выполнен: прямым чтением inventory, `LVL01.KWN`, sectors и class metadata составлен `documents/gameplay/content_catalog.md` для levels/sectors, персонажей, противников, интерактивов, RWS, cinematics и checkpoint; неподтверждённая семантика помечена явно.
