...
**Статус:** выполняется. Скелетная анимация и базовые материалы работают; следующий этап — фиксированный simulation timestep.
