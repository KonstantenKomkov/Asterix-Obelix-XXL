...
**Последнее обновление:** 22 июля 2026 — добавлен п. 74: передвигаемый Астериксом блок первого уровня сейчас смещён относительно оригинала и отображается металлическим; требуется восстановить правильные scene object, transform, геометрию и каменный материал вместе с collision/interaction.
