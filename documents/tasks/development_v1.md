...
**Статус:** выполняется. Импортированная статическая сцена загружается в Metal; следующий этап — scene graph и streaming секций.
...
**Последнее обновление:** 21 июля 2026 — п. 26 выполнен: Metal runtime загружает 381 mesh из локального ASTPAK, применяет scene transforms, depth buffer, базовый материал и ASTMTEX; profile-сверка подтвердила отображение Gaul-сцены при 60 FPS.
