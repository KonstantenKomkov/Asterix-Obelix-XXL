...
**Последнее обновление:** 22 июля 2026 — п. 54 выполнен: подтверждённая для использования иконка исходного приложения добавлена во все размеры macOS asset catalog и проверена в release `.app`.
