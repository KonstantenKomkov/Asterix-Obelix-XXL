...
**Последнее обновление:** 22 июля 2026 — п. 59 исправлен после runtime-проверки: вместо статического turn pose `0055` подключён многокадровый locomotion clip `0054`, а reconstruction сохраняет начальные keyframes; runtime отклоняет run clips без движения минимум 20 bone tracks.
