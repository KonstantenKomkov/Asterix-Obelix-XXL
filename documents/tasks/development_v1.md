...
**Последнее обновление:** 22 июля 2026 — п. 58 выполнен: раннее отпускание плавно сокращает восходящую фазу обоих прыжков, а удержание в течение 0,2 с сохраняет полную высоту; fixed-tick тесты подтверждают детерминированность минимальной и максимальной траекторий.
