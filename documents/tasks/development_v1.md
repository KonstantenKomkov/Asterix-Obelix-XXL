...
**Статус:** выполняется. Ввод для gameplay vertical slice завершён; следующий этап — state machine Астерикса.
...
- [ ] П. 33–39 — игровые системы vertical slice
- [ ] П. 40–43 — аудио, presentation, приёмка M4 и решение о продолжении
- [ ] П. 44–50 — полный контент, качество и release candidate

---

**Последнее обновление:** 21 июля 2026 — п. 32 выполнен: клавиатура и Xbox/PlayStation-совместимые extended gamepad сведены в единые actions для gameplay и паузы; раскладки переназначаются и сохраняются, disconnect очищает состояние, reconnect восстанавливает handlers.
