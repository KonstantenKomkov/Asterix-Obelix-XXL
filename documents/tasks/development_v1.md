...
**Последнее обновление:** 22 июля 2026 — добавлен п. 72: в текущей сборке на горящих домах отсутствует видимый анимированный огонь; требуется восстановить исходные FX-ресурсы, объектные привязки, материалы и эталонный цикл воспроизведения.
