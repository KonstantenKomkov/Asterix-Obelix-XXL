...
**Последнее обновление:** 22 июля 2026 — п. 73 выполнен: подтверждён исходный material UV transformation path, шесть водных материалов Gaul получили отдельные направления и скорости, Metal вычисляет фазу от simulation time, а pause/restore/streaming и движение против static fallback покрыты pipeline/native regressions.
