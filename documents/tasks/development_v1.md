...
- [ ] П. 6–7 — M0: каталог контента и контрольные состояния
...
**Последнее обновление:** 21 июля 2026 — п. 5 выполнен: в `documents/gameplay/reference_parameters.md` зафиксированы resolution, camera/FOV payload, нормализованные параметры движения и прыжка, боевые тайминги, damage/recovery диапазоны, методы, погрешности и уровни доверия.
