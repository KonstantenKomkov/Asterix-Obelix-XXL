...
**Статус:** выполняется. Коллизии мира и движение капсулы работают; следующий этап — debug tooling базового 3D-движка.
...
**Последнее обновление:** 21 июля 2026 — п. 30 выполнен: collision payload включён в importer proof/ASTPAK, C++ capsule controller обрабатывает пол, стены, допустимые склоны, ступени, dynamic ground и checkpoint recovery; детерминированный маршрут проходит без провалов и останавливается у стены.
