...
**Статус:** выполняется. Presentation MVP завершён; следующий этап — приёмка vertical slice.
...
- [ ] П. 42–43 — приёмка M4 и решение о продолжении
- [ ] П. 44–50 — полный контент, качество и release candidate

---

**Последнее обновление:** 21 июля 2026 — п. 41 выполнен: launch/menu/profile/settings flow адаптирован к 560×420 и 1440×900, fullscreen связан с NSWindow, ru/en locale и управляемые субтитры применяются без перезапуска.
