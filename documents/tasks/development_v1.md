...
**Последнее обновление:** 22 июля 2026 — п. 59 повторно проверен на реальном вводе: ошибочный turn/lean clip `0054` заменён настоящим беговым циклом `0035`, найденным в hero animation dictionary и подтверждённым последовательными кадрами при зажатом движении; диагностический override удалён.
