...
**Статус:** выполняется. Gameplay-камера завершена; следующий этап — боевая система и первая комбинация.
...
- [ ] П. 35–39 — игровые системы vertical slice
- [ ] П. 40–43 — аудио, presentation, приёмка M4 и решение о продолжении
- [ ] П. 44–50 — полный контент, качество и release candidate

---

**Последнее обновление:** 21 июля 2026 — п. 34 выполнен: fixed-tick gameplay camera следует за player target через dead zones, поддерживает AABB parameter zones, FOV 70°, collision avoidance и единый camera snapshot для projection/culling/LOD.
