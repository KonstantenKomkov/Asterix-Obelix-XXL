...
**Последнее обновление:** 22 июля 2026 — добавлен п. 73: вода в текущей сборке отображается статично; требуется определить используемый оригиналом механизм, перенести его данные и восстановить эталонное движение водных поверхностей.
