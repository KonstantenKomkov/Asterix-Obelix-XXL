...
Каждая экспортированная scene-node также содержит `sourcePayload`: полный hex,
размер, длину разобранного общего/class-specific префикса и SHA-256. Поле нужно
для машинного FX-аудита и не переносится в runtime payload автоматически.
